...
class ConfidenceAPITests(APITestCase):
    ...
    def base_test_function(self, request_data, response_fare):
    ...
    def test_day_response(self):
        data = {"journeys_list": [{"date-time": "2021-05-03 10:20:00", "from_zone": 2, "to_zone": 1},
        ...
        self.base_test_function(request_data=data, response_fare=120)
    ...
    def test_week_response(self):
        ...
        self.base_test_function(request_data=data, response_fare=700)

    def test_week_cap(self):
        data = {"journeys_list": [{"date-time": "2021-03-01 07:00:00", "from_zone": 2, "to_zone": 2},
        ...
        self.base_test_function(request_data=data, response_fare=400)

    def test_daily_cap(self):
        data = {"journeys_list": [{"date-time": "2021-03-01 07:00:00", "from_zone": 1, "to_zone": 1},
    ...
    def test_enter_zone_1_in_peak_hour(self):
        data = {"journeys_list": [{"date-time": "2021-03-01 17:00:00", "from_zone": 2, "to_zone": 1},
                                  {"date-time": "2021-03-01 18:00:00", "from_zone": 1, "to_zone": 1},
                                  {"date-time": "2021-03-01 19:00:00", "from_zone": 1, "to_zone": 2}
                                  ]
                }
        self.base_test_function(request_data=data, response_fare=95)

    def test_enter_zone_2_in_peak_hour(self):
        data = {"journeys_list": [{"date-time": "2021-03-01 17:00:00", "from_zone": 1, "to_zone": 2},
                                  {"date-time": "2021-03-01 18:00:00", "from_zone": 2, "to_zone": 2},
                                  {"date-time": "2021-03-01 19:00:00", "from_zone": 2, "to_zone": 1}
                                  ]
                }
        self.base_test_function(request_data=data, response_fare=90)
    ...
    def test_week_and_day_cap(self):
        ...
        self.base_test_function(request_data=data, response_fare=720)

    def test_monthly_fare(self):
        data = {"journeys_list": [{"date-time": "2020-01-01 09:00:00", "from_zone": 1, "to_zone": 2},
        ...
        self.base_test_function(request_data=data, response_fare=2015)
    ...
    def test_no_zone_error(self):
        url = reverse('calculate-fare')
        data = {"journeys_list": [{"date-time": "2021-05-03 10:20:00", "from_zone": 1, "to_zone": 2},
